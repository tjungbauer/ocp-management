#!/bin/bash
# Origin: https://github.com/openshift/openshift-ansible-contrib.git
#      ... reference-architecture/day2ops/scripts
#
# Modified for SIT
# copy this to every master
# be sure that /backup can be mounted
...
BACKUPLOCATION=${1:-"/backup/$(hostname)/$(date +%Y-%m-%d)/nodebackup-$(date +%Y%m%d)"}
